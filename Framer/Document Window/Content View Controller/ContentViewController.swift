...
final class ContentViewController: NSViewController {
    ...
    init(document: Document) {
        ...
        self.layoutController = LayoutController(document: self.document, layerStateHistory: document.layerStateHistory, viewStateController: self.viewStateController)
